...
class DeliveryDetail(scrapy.Spider):
    name = 'fedex'
    start_urls = ['https://www.fedex.com/fedextrack/?trknbr=536539312478&trkqual=12022~536539312478~FDEG']
    headers = {
        "Accept": "*/*",
    ...
    def parse(self, response):
        ...
        print("Data: ")
        yield scrapy.Request(url, headers=self.headers, dont_filter = True, callback=self.parse_json)
